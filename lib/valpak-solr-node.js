...
function getSyndicatedOffers() {
  ...
  return regeneratorRuntime.async(function getSyndicatedOffers$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        return context$1$0.abrupt('return', query(Object.assign({
...
function getLocalOffers() {
  ...
  return regeneratorRuntime.async(function getLocalOffers$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
        return context$1$0.abrupt('return', query(Object.assign({
...
function handleResponse(response) {
  return regeneratorRuntime.async(function handleResponse$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      case 0:
...
function getVOParser(voField) {
  return function getParsedVOs(data) {
    var response;
    return regeneratorRuntime.async(function getParsedVOs$(context$2$0) {
